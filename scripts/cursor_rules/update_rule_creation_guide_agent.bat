@echo off
REM Update script for rule_creation_guide cursor rule with agent-friendly settings
...
if not exist tmp_rules_rebuild\rule_creation_guide_agent.md echo ERROR: Content file tmp_rules_rebuild\rule_creation_guide_agent.md not found && exit /b 1
...
echo description: Guidelines for creating agent-friendly cursor rules   >> .cursor\rules\rule_creation_guide.mdc
...
type tmp_rules_rebuild\rule_creation_guide_agent.md                    >> .cursor\rules\rule_creation_guide.mdc

echo rule_creation_guide updated with agent-friendly guidelines. 