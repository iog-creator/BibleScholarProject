...
REM Generated on 05/05/2025 17:53:35
...
if not exist tmp_rules_rebuild/rule_creation_guide_refined.md echo ERROR: Content file tmp_rules_rebuild/rule_creation_guide_refined.md not found && exit /b 1
...
type tmp_rules_rebuild/rule_creation_guide_refined.md                                                     >> .cursor\rules\rule_creation_guide.mdc
